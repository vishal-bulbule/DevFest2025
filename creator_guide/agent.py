...
Keep the response limited to 100 words in bullet points
""",
...
creator_guide_agent = ParallelAgent(
    name="CreatorGuideAgent",
    sub_agents=[blog_agent, youtube_agent, instagram_agent],
    description="Generates blog ideas, Suggested YouTube video, and Instagram reel ideas in parallel."
)

# Root agent (for ADK compatibility)
root_agent = creator_guide_agent
